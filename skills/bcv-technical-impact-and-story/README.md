...
2. `technical-story-enriched.md` — implementation-ready technical story with numbered, traceable tasks,
   architecture diagram, detailed action plan (DoR, DoD, test cases, error scenarios, deployment notes, files affected),
   repository file impact and developer review & sign-off.
